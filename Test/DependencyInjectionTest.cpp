...
namespace DependencyInjectionTest {
  ...
  TEST(ServiceProviderTest, CanInjectTransientServiceIntoTransientService)
  {
    ...
    auto serviceProvider = serviceCollection.build();
    auto service = serviceProvider->getTransientService<ServiceWithTransientDependency>();
    ASSERT_NE(nullptr, service);
    auto secondInstance = serviceProvider->getTransientService<ServiceWithTransientDependency>();
  ...
  TEST(ServiceProviderTest, CanInjectTransientServiceIntoSingletonService)
  {
    ...
    ASSERT_NE(nullptr, service);
    auto secondPointer = serviceProvider->getService<ServiceWithTransientDependency>();
  ...
  TEST(ServiceProviderTest, CanInjectTransientServiceIntoScopedService)
  {
    ...
    ASSERT_NE(nullptr, service);
    auto secondPointer = serviceScope->getService<ServiceWithTransientDependency>();
    ASSERT_EQ(service, secondPointer);
    ASSERT_EQ(service->_leafService, secondPointer->_leafService);
    auto serviceScope2 = serviceProvider->createScope();
    auto secondInstance = serviceScope2->getService<ServiceWithTransientDependency>();
    ASSERT_NE(nullptr, secondInstance);
  ...
  TEST(ServiceProviderTest, CanInjectSingletonServiceIntoTransientService)
  {
    ...
    ASSERT_NE(nullptr, service);
    auto secondInstance = serviceProvider->getTransientService<ServiceWithDependency>();
    ASSERT_NE(nullptr, secondInstance);
    ASSERT_NE(service, secondInstance);
  ...
  TEST(ServiceProviderTest, CanInjectScopedServiceIntoTransientService)
  {
    ...
    ASSERT_NE(nullptr, service);
    auto secondInstance = serviceScope->getTransientService<ServiceWithDependency>();
    ASSERT_NE(nullptr, secondInstance);
    ASSERT_NE(service, secondInstance);
    ASSERT_EQ(&service->_leafService, &secondInstance->_leafService);
    auto serviceScope2 = serviceProvider->createScope();
    auto thirdInstance = serviceScope2->getTransientService<ServiceWithDependency>();
  ...
  struct DestructorTestClass1
  {
    ...
    ~DestructorTestClass1()
    {
      ...
      *_dependency._failure = *_dependency._failure || _dependency._value != 0b1110;
    }
  };
  ...
  struct DestructorTestClass2
  {
    ...
    ~DestructorTestClass2()
    {
      ...
      *_dependency._dependency._failure = *_dependency._dependency._failure || _dependency._dependency._value != 0b1100;
    }
  };
  ...
  struct DestructorTestClass3
  {
    ...
    ~DestructorTestClass3()
    {
      ...
      *_dependency._dependency._dependency._failure = *_dependency._dependency._dependency._failure || _dependency._dependency._dependency._value != 0b1000;
    }
  };
  ...
  struct ServiceWithMultipleDependencies1
  {
    ...
    ServiceWithMultipleDependencies1(
      LeafService1& leafService1,
  ...
  TEST(ServiceProviderTest, CanCreateComplexDependencyTree)
  {
    ...
    auto serviceProvider = serviceCollection.build();
    auto serviceScope = serviceProvider->createScope();
    auto& rootService = serviceScope->getRequiredService<ServiceWithMultipleDependencies3>();
    auto& service2 = serviceScope->getRequiredService<ServiceWithMultipleDependencies2>();
    ASSERT_EQ(&rootService._serviceWithMultipleDependencies2, &service2);
    auto& service1 = serviceScope->getRequiredService<ServiceWithMultipleDependencies1>();
    ASSERT_EQ(&service2._serviceWithMultipleDependencies1, &service1);
    auto serviceScope2 = serviceProvider->createScope();
    auto& rootServiceScope2 = serviceScope2->getRequiredService<ServiceWithMultipleDependencies3>();
    auto& service2Scope2 = serviceScope2->getRequiredService<ServiceWithMultipleDependencies2>();
    ASSERT_EQ(&rootServiceScope2._serviceWithMultipleDependencies2, &service2Scope2);
    auto& service1Scope2 = serviceScope2->getRequiredService<ServiceWithMultipleDependencies1>();
    ...
    ASSERT_EQ(&service2Scope2._serviceWithMultipleDependencies1, &service2._serviceWithMultipleDependencies1);
    auto& service1FromProvider = serviceProvider->getRequiredService<ServiceWithMultipleDependencies1>();
  ...
  TEST(ServiceProviderTest, CanInjectMultipleServices)
  {
    ...
    auto serviceProvider = serviceCollection.build();
    auto service = serviceProvider->getRequiredService<ServiceRequestingVectorOfServices>();
  ...
  struct ServiceRequestingVectorOfTransientServices
  {
    ...
    ServiceRequestingVectorOfTransientServices(std::vector<std::shared_ptr<IService>>&& services)
      : _services(std::move(services))
    {}
  };
  ...
  TEST(ServiceProviderTest, CanInjectMultipleTransientServices)
  {
    ...
    auto serviceProvider = serviceCollection.build();
    auto service = serviceProvider->getRequiredService<ServiceRequestingVectorOfTransientServices>();
    ASSERT_EQ(3, service._services.size());
  }
}
